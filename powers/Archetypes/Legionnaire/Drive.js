exports.power = {
  name: "Drive", //name of power (REQUIRED)
  ...
  range: "8 Meters", //how far it travels, this is a string ("3 meters" or "3M/S) (false if not specified)
  cost: "15 Rage", //localized cost to archetype (energy, rage, mana, etc), false if not listed.
  tooltip: "Stab in front of you for 750 - 916 + 83% Weapon Damage as Piercing Damage. Applies a Weapon Break to all hit, which reduces all Damage they deal by 20% for 15 seconds.", //full description of power (REQUIRED)
